...
/**
 * Command for approving client demands, it changes demand in database and return to the demand manage page 
 * 
 * @author Anton Suprunyuk
 */
public class ApproveDemandCommand implements ActionCommand {
	...
	public String execute(HttpServletRequest request) {
		...
		if (request.getSession().getAttribute(CLIENT_ID_ATTRIBUTE) != null) {
			...
			if (clientId == 0) {
				...
				DemandLogic.approve(demandId, true);							
